import { Button, Card, Label, Divider, Grid, Icon } from 'semantic-ui-react';
...
class UserCard extends React.Component {
    ...
    toggleAddFriend() {
        ...
        if (!previousState) {
            ...
            info.friends.splice(info.friends.indexOf(this.props.keyUrl));
        }
        var data = {
                    ...
                    <Card as={Link} to={"/u/" + this.props.user.info.username} style={CardStyle.card}>
                        <Card.Content>
                            <Grid columns={3} stretched>
                                ...
                                <Grid.Column width={1} style={{ paddingLeft: 0, height: 'min-content' }}>
                                    <Icon link name="add user" onClick=""></Icon>
                                </Grid.Column>
