      ...
      <Grid centered inverted>
        ...
        <Grid.Row>
          <div style={FooterStyle.spacing}>
            <Button icon color="youtube" circular as="a" href="https://www.youtube.com/channel/UCt7fJA18qugGlVDaFrt63JQ">
              <Icon name="youtube play" />
            </Button>
          </div>
          <div style={FooterStyle.spacing}>
            <Button icon color="facebook" circular as="a" href="https://www.facebook.com/groups/aztecgamelab/">
              <Icon name="facebook f" />
            </Button>
          </div>
          <div style={FooterStyle.spacing}>
            <Button icon color="instagram" circular as="a" href="https://www.instagram.com/aztecgamelab/">
              <Icon name="instagram" />
            </Button>
          </div>
          <div style={FooterStyle.spacing}>
            <Button icon color="twitter" circular as="a" href="https://twitter.com/AztecGameLab">
              <Icon name="twitter" />
            </Button>
          </div>
        </Grid.Row>
        ...
        <Grid.Row>
          <List divided relaxed horizontal inverted>
            ...
            <List.Item
              icon="map signs"
              content={<a href="http://www.myatlascms.com/map/index.php?id=801#!s/key=adams?m/146395?ce/12160">Adams Humanities 1120</a>}
            />
